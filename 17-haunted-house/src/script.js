...
bush4.scale.set(0.16, 0.16, 0.16)
 ...
 * Ghosts
 */
const ghost1 = new THREE.PointLight('#ffffff', 1, 3)
const ghost2 = new THREE.PointLight('#fffffff', 1, 3)
const ghost3 = new THREE.PointLight('#ffffff', 1, 3)
...
doorLight.castShadow = textureLoader
